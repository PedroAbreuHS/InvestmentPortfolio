...
var NavMenuComponent = function () {
    ...
    var NavMenuComponent = _classThis = /** @class */ (function () {
        function NavMenuComponent_1(router) {
            this.router = router;
        ...
        NavMenuComponent_1.prototype.toggle = function () {
            this.isExpanded = !this.isExpanded;
        };
        NavMenuComponent_1.prototype.getUserData = function () {
            this.userLogged = JSON.parse(localStorage.getItem('user_logged'));
            this.isAuthenticated = this.userLogged != null;
        };
        NavMenuComponent_1.prototype.logout = function () {
